...
class EU_COOKIES_BAR_Admin_Admin {
	...
	public function settings_link( $links ) {
		$settings_link = '<a href="admin.php?page=eu-cookies-bar" title="' . esc_html__( 'Settings', 'eu-cookies-bar' ) . '">' . esc_html__( 'Settings', 'eu-cookies-bar' ) . '</a>';
	...
	public function admin_menu() {
		add_menu_page( esc_html__( 'WordPress EU Cookies', 'eu-cookies-bar' ), esc_html__( 'Cookies bar', 'eu-cookies-bar' ), 'manage_options', 'eu-cookies-bar', array(
			$this,
			'settings'
		), '', 2 );
